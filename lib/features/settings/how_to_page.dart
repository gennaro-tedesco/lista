  ...
  static const _sections = [
    ...
    (
      ...
      actions: [
        ...
        'Tap the note icon above the categories to open and save a note for the list.',
        'Tap the search icon to search items; matching items are highlighted and the list scrolls to the first match.',
